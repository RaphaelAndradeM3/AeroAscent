...
- [ ] T002 [P] Validar e estender a fixture de repositório em memória `ProgressoRepositorioMock` para suporte à oficina em `tests/AeroAscent.Core.Aplicacao.Testes/Fixtures/ProgressoRepositorioMock.cs`
