...
- **FR-001**: O sistema DEVE fornecer o serviço `IServicoAudio` desacoplado, com implementação `ServicoAudioUnity` para gerenciar canais de efeitos (SFX) e música ambiente.
...
- As partículas utilizam o sistema nativo de partículas otimizado da Unity (Shuriken Particle System).
