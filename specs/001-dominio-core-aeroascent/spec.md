...
- O domínio será compilado em biblioteca de classes C# (.NET Standard 2.1 / .NET 8), consumível nativamente pelo projeto Unity em Windows e Android.
